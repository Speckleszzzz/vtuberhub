...
const NavBar = () => {
  return (
    <div style={{ backgroundImage: `url(${welcomewallpaper})` }} className='bg-cover bg-center h-screen h-vh[80]'>
      <div className='py-3 sticky-header'>
        <div className='flex justify-between px-5 h-vh[10] items-center bg-black opacity-80 mx-20 rounded-full'>
          <div>
        ...
        <div>
          <div className='text-center text-white absolute left-36 py-80'>
              ...
              <p>
                <a href='/upload' className='w-48 text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-center dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-800' >
                  Upload Content
                </a>
            </p>
              <br></br>
