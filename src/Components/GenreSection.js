    ...
    return (
      <div>
        <div className='mx-40 flex justify-between'>
          ...
          <div>
            <button onClick={this.handleClick} id="dropdownCheckboxButton" className="w-48 text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-800 aboslute" type="button">
              Filter options
            ...
            <div id="dropdownDefaultCheckbox" className={`z-10 ${dropdownVisible ? '' : 'hidden'} w-48 bg-gray-700 divide-y divide-gray-400 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}>
              <ul className="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownCheckboxButton">
                ...
                <li>
                  <div className="flex items-center">
                    <input checked id="checkbox-item-2" type="checkbox" value="" className="w-4 h-4 text-gray-600 bg-gray-400 border-gray-300 rounded focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"/>
